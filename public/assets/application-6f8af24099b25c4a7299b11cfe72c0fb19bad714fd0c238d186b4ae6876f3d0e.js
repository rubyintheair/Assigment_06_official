...
// All this logic will automatically be available in application.js.
;
// adapted from: https://medium.com/wolox-driving-innovation/infinite-scrolling-ruby-on-rails-3fcd3bac0f75
// OKAY to copy and paste the following
...
$(".comment-button").click(function(){
  $(this).$(".comment-form").removeClass("hidden");
});
var options = {
  url: function(name) {
